    ...
    <div>
        ...
        <scroller class="main-list" offset-accuracy="300px">
            ...
            <div class="cell-button">
                <YXSlider :imageList="YXBanners"></YXSlider>
                <div class="slogan" @click="jump('/page/webview')">
            ...
            <div class="cell-button">
                <Block1 :title="block1.title" :items="block1.items"></Block1>
            </div>
            <div class="cell-button">
                <Block2 hasMore=true newGoods=true :head="head1" :goods="goods1"></Block2>
            </div>
            <div class="cell-button">
                <Block2 hasMore=true hotGoods=true :head="head2" :goods="goods2"></Block2>
            </div>
            <div class="cell-button">
                <Block3 :goods="goods3"></Block3>
            </div>
        </scroller>
        <TabBar></TabBar>
    </div>
                    ...
                    items: [
                        {
                            ...
                            url:"http://m.you.163.com/item/manufacturer?tagId=1001037&page=1&size=100"
                        },
                        {
                            name: "MUJI制造商",
                            price: "12.9",
                            ...
                            url:"http://m.you.163.com/item/manufacturer?tagId=1001000&page=1&size=100"
                        },
                        {
                            name: "罗莱制造商",
                            price: "199",
                            ...
                            url:"http://m.you.163.com/item/manufacturer?tagId=1001045&page=1&size=100"
                        },
                        {
                            name: "Adidas制造商",
                            price: "29",
