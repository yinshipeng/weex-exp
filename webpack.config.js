...
const plugins = [
    new CopyWebpackPlugin([
        ...
        { from: './node_modules/vue/dist/vue.runtime.js', to: './lib/vue.runtime.js' },
        { from: './node_modules/weex-vue-render/dist/index.js', to: './lib/weex-vue-render.js' }
    ]),
...
if (process.env.NODE_ENV === 'production') {
    webConfig.plugins = (webConfig.plugins || []).concat([
        /*
    ...
    weexConfig.plugins = (weexConfig.plugins || []).concat([
        /*
         * Plugin: UglifyJsPlugin
         * Description: UglifyJS plugin for webpack
         * See: https://github.com/webpack-contrib/uglifyjs-webpack-plugin
